...
namespace Invector.vCharacterController
{
    public class vThirdPersonAnimator : vThirdPersonMotor
    {
        ...
        public void UpdateAnimator()
        {
            ...
            animator.SetBool(vAnimatorParameters.IsAimingAndShooting, isAimingAndShooting);
            animator.SetBool(vAnimatorParameters.IsReloading, isReloading);
    ...
    public static partial class vAnimatorParameters
    {
        ...
        public static int IsAimingAndShooting = Animator.StringToHash("IsAimingAndShooting");
        public static int IsNotAimingAndShooting = Animator.StringToHash("IsNotAimingAndShooting");
